...
from eval_classifier_simp import evaluate_e2e
import pdb
#pdb.set_trace()
...
def main():
    ...
    val = "./data_roadnetwork/chengdu/simplification/simp_data_val"
    val_dir = "./data_roadnetwork/chengdu/simplification/simp_dir_val"
    val_label = "./data_roadnetwork/chengdu/simplification/simp_label_val"
    val_feature = "./data_roadnetwork/chengdu/simplification/simp_fe_val"
...
#    val_feature = "./efficiency/2/untest_fe_combine2"
    ...
    de_times = 2.5
    grop_num = 2
    train = "./data_roadnetwork/chengdu/simplification/simp_data"
    train_dir = "./data_roadnetwork/chengdu/simplification/simp_dir"
    train_label = "./data_roadnetwork/chengdu/simplification/simp_label"
    train_feature = "./data_roadnetwork/chengdu/simplification/simp_fe"
