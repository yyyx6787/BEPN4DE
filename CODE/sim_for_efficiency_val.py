...
unsim_train_data = "./data_roadnetwork/chengdu/val_data.pickle"
unsim_train_direction = "./data_roadnetwork/chengdu/val_direction.pickle"
unsim_train_label = "./data_roadnetwork/chengdu/val_label.pickle"
unsim_train_fea = "./data_roadnetwork/chengdu/val_feature.pickle"
...
file=open(r"./data_roadnetwork/chengdu/simplification/simp_data_val","wb")
pickle.dump(whole_sim,file) #storing_list
file.close()

file=open(r"./data_roadnetwork/chengdu/simplification/simp_label_val","wb")
pickle.dump(whole_sim_label,file) #storing_list
file.close()

file=open(r"./data_roadnetwork/chengdu/simplification/simp_index_val","wb")
pickle.dump(whole_sim_index,file) #storing_list
file.close()

file=open(r"./data_roadnetwork/chengdu/simplification/simp_fe_val","wb")
pickle.dump(whole_sim_fe,file) #storing_list
file.close()

file=open(r"./data_roadnetwork/chengdu/simplification/simp_dir_val","wb")
