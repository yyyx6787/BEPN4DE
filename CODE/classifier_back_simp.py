...
de_times = 2.5
grop_num = 2
train = "./data_roadnetwork/chengdu/classfier_data/simp_data"
train_dir = "./data_roadnetwork/chengdu/classfier_data/simp_dir"
train_label = "./data_roadnetwork/chengdu/classfier_data/simp_label"
train_feature = "./data_roadnetwork/chengdu/classfier_data/simp_fe"
