...
#    print("\nevaluating model on:", data_url, "\n")
    ...
    model_1.load_state_dict(torch.load('./models/classifier.model'))
...
if __name__ == '__main__':
    ...
    #val_unsim = "./data_roadnetwork/chengdu/val_data.pickle"
    #val_unsim_label = "./data_roadnetwork/chengdu/val_label.pickle"
    #val_sim_index = "./data_roadnetwork/chengdu/val_index_{}.pickle".format(con_k)
    #compress data
    #anomaly_val_pre = "./efficiency/2/combine_data2"
