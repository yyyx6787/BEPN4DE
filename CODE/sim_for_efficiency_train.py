...
unsim_train_data = "./data_roadnetwork/chengdu/train_data_{}_{}_n.pickle".format(np.round(alpha,1),np.round(de_times,1))
unsim_train_direction = "./data_roadnetwork/chengdu/train_direction_{}_{}_n.pickle".format(np.round(alpha,1),np.round(de_times,1))
unsim_train_label = "./data_roadnetwork/chengdu/train_label_{}_{}_n.pickle".format(np.round(alpha,1),np.round(de_times,1))
unsim_train_fea = "./data_roadnetwork/chengdu/train_fea_{}_{}_n.pickle".format(np.round(alpha,1),np.round(de_times,1))


unsim_train_data = load_data(unsim_train_data)
unsim_train_direction = load_data(unsim_train_direction)
unsim_train_label = load_data(unsim_train_label)
unsim_train_fea = load_data(unsim_train_fea)
...
file=open(r"./data_roadnetwork/chengdu/simplification/simp_data","wb")
pickle.dump(whole_sim,file) #storing_list
file.close()

file=open(r"./data_roadnetwork/chengdu/simplification/simp_label","wb")
pickle.dump(whole_sim_label,file) #storing_list
file.close()

file=open(r"./data_roadnetwork/chengdu/simplification/simp_index","wb")
pickle.dump(whole_sim_index,file) #storing_list
file.close()

file=open(r"./data_roadnetwork/chengdu/simplification/simp_fe","wb")
pickle.dump(whole_sim_fe,file) #storing_list
file.close()

file=open(r"./data_roadnetwork/chengdu/simplification/simp_dir","wb")
